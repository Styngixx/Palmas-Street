document.addEventListener('DOMContentLoaded', () => {
      ...
      card.innerHTML = `
        <div class="card-body p-3">
          <div class="d-flex gap-3 align-items-center flex-wrap">
            <img src="${PalmasCart.escapeHTML(image)}" alt="${PalmasCart.escapeHTML(item.nombre)}" class="cart-item-img" onerror="this.src='/media/media-logos/LogoPS.png'">
    ...
    receiptContainer.innerHTML = `
      <div class="receipt-box">
        ...
        <div class="d-flex gap-2 justify-content-end mt-4 no-print">
          ...
          <a href="/index.html#catalogo" class="btn btn-dark">Volver al catálogo</a>
        </div>
      </div>
    `;
  ...
  if (finishPurchaseBtn) finishPurchaseBtn.addEventListener('click', finishPurchase);
